...
IMPLEMENT_SENSOR(Gc05a2)
Gc05a2::Gc05a2() : ISensor("gc05a2") {}

Gc05a2::~Gc05a2() {}

void Gc05a2::InitPhysicalSize(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitPhysicalSize(camera_meta_data);
}

void Gc05a2::InitAntiBandingModes(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitAntiBandingModes(camera_meta_data);
}

void Gc05a2::InitAeFpsTarget(Camera::CameraMetadata& camera_meta_data)
{
...
void Gc05a2::InitCompensationRange(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitCompensationRange(camera_meta_data);
}

void Gc05a2::InitSensitivityRange(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitSensitivityRange(camera_meta_data);
}

void Gc05a2::Init(Camera::CameraMetadata& camera_meta_data)
{
