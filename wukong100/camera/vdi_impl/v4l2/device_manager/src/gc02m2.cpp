...
IMPLEMENT_SENSOR(Gc02m2)
Gc02m2::Gc02m2() : ISensor("gc02m2") {}

Gc02m2::~Gc02m2() {}

void Gc02m2::InitPhysicalSize(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitPhysicalSize(camera_meta_data);
}

void Gc02m2::InitAntiBandingModes(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitAntiBandingModes(camera_meta_data);
}

void Gc02m2::InitAeFpsTarget(Camera::CameraMetadata& camera_meta_data)
{
...
void Gc02m2::InitCompensationRange(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitCompensationRange(camera_meta_data);
}

void Gc02m2::InitSensitivityRange(Camera::CameraMetadata& camera_meta_data)
{
    ISensor::InitSensitivityRange(camera_meta_data);
}

void Gc02m2::Init(Camera::CameraMetadata& camera_meta_data)
{
